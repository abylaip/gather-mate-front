...
const Home = () => {
  return (
    <div className="h-screen flex flex-row items-center justify-center bg-slate-100 space-x-40">
      <div className="flex flex-col">
        <p className="text-3xl font-bold text-blue-500">Gather Mate</p>
        <p className="text-xl font-semibold">
          Together We Thrive: Where <br />
          Friendship Sparks Unforgettable Events!
        </p>
      </div>
      <div className="flex flex-col space-y-5 rounded-xl bg-white shadow-2xl p-10">
        <p className=" font-semibold">You can sign in with:</p>
